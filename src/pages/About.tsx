...
const About = () => (
  <section className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-[#E5DEFF] via-[#f1f0fb] to-[#FDE1D3] animate-fade-in">
    <div className="bg-white/80 p-10 rounded-2xl shadow-xl flex flex-col items-center max-w-xl mx-auto">
      <h2 className="text-3xl font-extrabold text-[#9b87f5] mb-2">About FileLinker</h2>
      <p className="text-gray-700 text-lg mb-6 text-center">
        <span className="font-semibold">FileLinker</span> is a modern, secure SaaS for sharing files, folders, and documents with anyone—instantly!
      </p>
      <ul className="mb-6">
      ...
      <div className="text-sm text-gray-400">
        Built with ❤️ by the FileLinker Team. Contact: <a href="mailto:hello@filelinker.saas" className="underline text-[#9b87f5]">hello@filelinker.saas</a>
      </div>
    </div>
  </section>
);
